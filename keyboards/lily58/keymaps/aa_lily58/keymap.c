...
//  [_NUM] = LAYOUT(
//   _______, _______, _______, _______, _______, _______,                   S(KC_G), KC_PPLS, KC_PMNS, KC_PAST, KC_PSLS, KC_CIRC,
//   _______, _______, _______, _______, _______, _______,                   KC_PEQL,  KC_7,   KC_8,  KC_9, KC_LABK, XXXXXXX,
//   _______, _______, _______, _______, _______, _______,                   KC_0,  KC_4,   KC_5,  KC_6, KC_RABK, XXXXXXX,
//   _______, _______, _______, _______, _______, _______, _______,  KC_SPC, KC_DOT, KC_1,   KC_2,  KC_3, KC_PERC, XXXXXXX,
//                         QK_LLCK, _______, _______, _______,           _______,  _______, _______, QK_LLCK
// ),

 [_NUM] = LAYOUT(
  _______, _______, _______, _______, _______, _______,                   S(KC_G), KC_LABK, KC_RABK, KC_PERC, KC_CIRC, XXXXXXX,
  _______, _______, _______, _______, _______, _______,                   KC_PEQL,  KC_7,   KC_8,  KC_9, KC_PAST, KC_PSLS,
  _______, _______, _______, _______, _______, _______,                   KC_0,  KC_4,   KC_5,  KC_6, KC_PPLS, KC_PMNS,
  _______, _______, _______, _______, _______, _______, _______,  KC_SPC, KC_DOT, KC_1,   KC_2,  KC_3, KC_COMM, XXXXXXX,
                        QK_LLCK, _______, _______, _______,           _______,  _______, _______, QK_LLCK
),
 ...
 */
 ...
 [_SYM] = LAYOUT(
  ...
  _______, KC_PIPE, KC_TILD, KC_GRV,  KC_LCBR, KC_RCBR,                  _______, _______, _______, _______, _______, _______,
  _______, KC_AMPR, KC_UNDS, KC_DQUO, KC_LPRN, KC_RPRN,                  _______, _______, _______, _______, _______, _______,
  _______, KC_BSLS, KC_MINS, KC_QUOT, KC_LBRC, KC_RBRC, KC_ENT, _______, _______, _______, _______, _______, _______, _______,
                        QK_LLCK, _______, _______, _______,         _______,  _______, _______, QK_LLCK
  ),
 ...
 */
 ...
 [_FUN] = LAYOUT(
  ...
  _______,  KC_F20, KC_MUTE, KC_VOLD, KC_VOLU, _______,                   _______, _______, _______, _______, _______, _______,
  _______, _______, KC_PSCR, KC_BRID, KC_BRIU, _______, KC_BSPC, _______, _______, _______, _______, _______, _______, _______,
                        QK_LLCK, _______, _______, _______,            _______,  _______, _______, QK_LLCK
  )
};
